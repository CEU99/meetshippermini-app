-- =====================================================================
-- Quick Inbox Match Check - Ready for aysu16
-- =====================================================================
-- User: @aysu16
-- FID: 1394398
-- =====================================================================
...
SELECT
  ...
  m.created_at,
  CASE
    WHEN m.user_a_fid = 1394398 THEN '👉 aysu is user_a'
    WHEN m.user_b_fid = 1394398 THEN '👉 aysu is user_b'
    ELSE 'other match'
  END as aysu_role,
...
WHERE m.user_a_fid = 1394398
   OR m.user_b_fid = 1394398
